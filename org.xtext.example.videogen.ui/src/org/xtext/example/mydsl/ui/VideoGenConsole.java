...
public class VideoGenConsole {

    private static VideoGenConsole self;

    public static VideoGenConsole getInstance() {
        if (self == null)
            self = new VideoGenConsole();
        return self;
    }
    ...
    private VideoGenConsole() {
        console = new IOConsole("[VideoGen]", null);
